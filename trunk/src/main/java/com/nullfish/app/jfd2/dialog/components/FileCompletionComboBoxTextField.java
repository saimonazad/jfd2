 ...
 * @author shunji
 */
public class FileCompletionComboBoxTextField extends ComboBoxTextField {
	private VFS vfs;
	...
	public FileCompletionComboBoxTextField(JFD jfd) {
		this(jfd, MODE_DIRECTORY);
		initFocusListener();
	}

	public FileCompletionComboBoxTextField(JFD jfd, int mode) {
		super();
		this.jfd = jfd;
